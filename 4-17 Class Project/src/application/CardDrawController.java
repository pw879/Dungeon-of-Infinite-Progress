...
public class CardDrawController {
	...
	private Boolean success = true;      // a boolean that determines if day successful or not - from controller.
	...
	*///===============================================================================
	public void standardReward() { 
		...
		cardDescription.setText("NO ITEMS FOUND");
	...
	*/ //===============================================================================
	...
	public void standardDeduction() {
		...
		itemOrMonster.setText("NO MONSTERS HERE");              //label is assigned monster name
		//outcomeDescription.setText("YOU TRAVEL UNHARMED");      //label is assigned a string describing battle outcome
		cardDescription.setText("YOUR GOALS WERE UNMET BUT AT LEAST THERE ARE NO MONSTERS");                   // type of monster encountered //change later
		...
		if (rand.nextInt(10) <= 5) {      
			...
			monsterLevelDisplay.setText(String.valueOf(monster.getMonsterLevel()));  // level of monster 
			itemOrMonster.setText(monster.getMonsterType());                     // string for monster name
			cardDescription.setText(monster.getmyCardOutCome());                // outcome of monsterbattle from model
	...
	*/ //===============================================================================
	...
	public void setCardImage(String name) {
		...
		Image monster1 = new Image("\\images\\monster1.png"); // goal troll 
		Image monster2 = new Image("\\images\\monster2.png"); // black dragon 
		Image monster3 = new Image("\\images\\monster3.png"); // wizard
		Image monster4 = new Image("\\images\\monster4.png"); // dark elf 
		...
		if(name.equals("TIME THIEF")) cardDisplay.setImage(monster2);
		if(name.equals("DARK PROCRASTINATOR")) cardDisplay.setImage(monster4);
		if(name.equals("DRAGON OF SLOTH")) cardDisplay.setImage(monster3);
		//if(name.equals("no monster")) cardDisplay.setImage();
	}
	...
	*/ //===============================================================================
	...
	/* =================================================================================
	* Class Description: prepareBonus
	* 	A method that activates if OK button is clicked.
	* 
	* Arguments:
	* 	none
	...
	* 	nothing
	*/ //===============================================================================
	public void prepareBonus(BonusItem item){
	String itemName = item.getRewardName();
	String itemDescription = item.getItemDescription();
	int itemValue = item.getSellValue();
	int itemExperience = item.getExpValue(); // may not need this
	
	// put reward into list, FIX
	//Reward bonusReward = new Reward(itemName, itemDescription, itemValue);
	//InventoryList myInventory = new InventoryList();
	//myInventory.addInventory(bonusReward);
	}
	}
